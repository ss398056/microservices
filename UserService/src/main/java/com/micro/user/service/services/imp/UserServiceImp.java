package com.micro.user.service.services.imp;
...
public class UserServiceImp implements UserService {
	...
	public List<User> getAllUser() {
		...
		users.forEach(user->{
//			Rating[] ratingArr = restTemplate.getForObject("http://RATINGSERVICE/ratings/user/"+user.getUserId(), Rating[].class);
...
//				logger.info("{} ",forEntity.getStatusCode());
	...
	public User getUser(String userId) {
		...
		User user = userRepo.findById(userId).orElseThrow(()-> new ResourceNotFoundException("Record not found with given "+userId));
		
		//fetch ratings of the user
		
//		Rating[] ratingArr = restTemplate.getForObject("http://RATINGSERVICE/ratings/user/"+userId, Rating[].class);
//		
//		List<Rating> ratings = Arrays.stream(ratingArr).toList();
